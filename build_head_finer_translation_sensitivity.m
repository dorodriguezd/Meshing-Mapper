...
baselineHeadDatFile = fullfile(inputDir, 'head_finer.dat');
targetDatFile = fullfile(inputDir, 'mesh_base.dat');
...
cases = struct( ...
    'Name', {'1mm_zUP', '1mm_zDOWN'}, ...
    'TranslationVector', {[0 0 0.001], [0 0 -0.001]});
...
for caseIndex = 1:numel(cases)
    ...
    transformInfo = transformMeshGeometry( ...
        baselineHeadDatFile, ...
        translatedDatFile, ...
